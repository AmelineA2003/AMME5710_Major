...
if __name__ == "__main__":
    ...
    while frame_idx < len(rgb_frames):
        if not paused:
            ...
            output = GetHeadPose(face_cascade, eye_cascade, mouth_cascade, nose_cascade, rgb, height)
            ...
            cv2.imshow(mine_window_name, output["Mine"])  # 'img2' is your annotated image (ensure it is in BGR format for display)
            ...
            cv2.imshow(media_pipe_window_name, output["MediaPipe"])
