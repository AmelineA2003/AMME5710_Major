...
"""
Use this script to produce RGB videos and corresponding height maps videos using the Intel Realsense Camera.
The script saves a .pkl file that stores both RGB and height map video.
"""
...
try:
    ...
    if rgb_frames and height_frames and len(rgb_frames) == len(height_frames):
        ...
        picke_name = 'realsense_rgb_height.pkl'

        with open(picke_name, 'wb') as f:
            pickle.dump(data, f)
